            ...
            <div className="relative shadow-xl h-screen  sm:overflow-hidden">
              ...
              <div className="relative px-4 h-screen py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">Wine Recommender </span>
                  <span className="block text-indigo-200">System</span>
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-lg	 font-semibold	 md:text-xl text-indigo-200 sm:max-w-3xl">
                I'm a final year undergraduate from the Department of Statistics, University of Colombo. I'm conducting this survery to gather data for the fullfillment of my final year research, "Use of AI to predict the best maching wines for individuals"
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-lg font-semibold		md:text-xl text-indigo-200 sm:max-w-3xl">
                The collected information will be only used for my academic purpose and will not be handed over to anyone without permission. Thank you for your valuable time and consideration. 
                </p>
